  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> AT GOEASE
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<h2> Register Here For A New Account </h2>
...
$from = "sad.ahmed22224@gmail.com";
    ...
    $message = "<h2>Email Confirmation By$c_name</h2><br>";
...
values ('$c_name','$c_email','$c_pass','abc','abc','$c_contact','$c_address','xyz','$c_ip','$customer_confirm_code')";
